...
@Component({
    ...
    imports: [CustomPaginationComponent,CommonModule,FormsModule,MatSort
      ,DateRangePickerComponent,CollapseHeaderComponent,RouterLink
    ]
})
export class SubscriptionsComponent {
  ...
  private getTableData(pageOption: pageSelection): void {
    this.data.getSubscription().subscribe((apiRes: apiResultFormat) => {
      ...
      this.dataSource = new MatTableDataSource<CompanyInfo>(this.tableData);
