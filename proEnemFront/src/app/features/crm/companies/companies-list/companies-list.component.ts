...
import { apiResultFormat, companiesList, pageSelection } from '../../../../shared/model/pages.model';
...
@Component({
    ...
    imports: [CustomPaginationComponent,CommonModule,FormsModule,MatSelectModule,MatIconModule
