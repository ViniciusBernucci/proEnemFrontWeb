...
@Component({
  ...
  templateUrl: './activity-calls.component.html',
  styleUrl: './activity-calls.component.scss'
})
export class ActivityCallsComponent {
 ...
 constructor(
    ...
    this.data.getActivityCalls().subscribe((apiRes: apiResultFormat) => {
      this.actualData = apiRes.data;
      this.pagination.tablePageSize.subscribe((res: tablePageSize) => {
        if (this.router.url == this.routes.activityCalls) {
