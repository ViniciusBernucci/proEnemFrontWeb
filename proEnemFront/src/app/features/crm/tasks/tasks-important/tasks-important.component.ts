...
@Component({
  ...
  imports: [MatSelectModule,SelectModule,MatIconModule,MatChipsModule,RouterLink,CollapseHeaderComponent,BsDatepickerModule,TagInputModule,CommonModule,FormsModule,DateRangePickerComponent,CollapseHeaderComponent],
  templateUrl: './tasks-important.component.html',
  styleUrl: './tasks-important.component.scss'
})
export class TasksImportantComponent {
routes=routes
tags=['Collab','VIP'];
selectedOption3: any;
   selectedOption4: any;
