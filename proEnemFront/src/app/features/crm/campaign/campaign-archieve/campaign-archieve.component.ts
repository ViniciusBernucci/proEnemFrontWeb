...
@Component({
  ...
  imports: [CommonModule,FormsModule,MatSortModule,CustomPaginationComponent,DateRangePickerComponent,CollapseHeaderComponent,RouterLink,MatSelectModule,TagInputModule,BsDatepickerModule],
  templateUrl: './campaign-archieve.component.html',
  styleUrl: './campaign-archieve.component.scss'
})
export class CampaignArchieveComponent {
  ...
  constructor(
    ...
    this.data.getCompaignArchive().subscribe((apiRes: apiResultFormat) => {
      ...
      this.pagination.tablePageSize.subscribe((res: tablePageSize) => {
        if (this.router.url == this.routes.campaignArchieve) {
