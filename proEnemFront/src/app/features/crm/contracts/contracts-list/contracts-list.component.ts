...
import { apiResultFormat, contractList, pageSelection } from '../../../../shared/model/pages.model';
...
@Component({
  ...
  imports: [CommonModule,FormsModule,MatSortModule,CustomPaginationComponent,DateRangePickerComponent,CollapseHeaderComponent,MatSelectModule,SelectModule,MatIconModule,MatChipsModule,RouterLink,NgxEditorModule,BsDatepickerModule],
